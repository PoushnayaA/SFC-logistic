...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _initServicesSlider.initServicesSlider)();
  (0, _initNewsSlider.initNewsSlider)();
  (0, _iosVhFix.iosVhFix)();
  window.addEventListener('load', function () {});
});

},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./modules/slider/init-news-slider":11,"./modules/slider/init-services-slider":12,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
